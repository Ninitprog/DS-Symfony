 ...
 */
final class Version20220415091549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE taches (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, priorite_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_3BF2CD98A76ED395 (user_id), INDEX IDX_3BF2CD9853B4F1DE (priorite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
